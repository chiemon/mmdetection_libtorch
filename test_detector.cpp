...
int main() {
  ...
  // "/home/dl/Project/mmdetection_libtorch/config/ssd.json";
  std::string config_file =
      "/home/dl/Project/mmdetection_libtorch/config/re.json";
  // std::string config_file =
  ...
  cv::Mat image =
      cv::imread("/home/dl/Project/mmdetection_libtorch/image/000020.jpg");
