...
void ReadRetinaHeadParams(const Value& root, RetinaHeadParams& RetinaHead) {
  ...
  RetinaHead.octave_base_scale_ =
      root["RetinaHead"]["octave_base_scale"].asInt();
  RetinaHead.scales_per_octave_ =
      root["RetinaHead"]["scales_per_octave"].asInt();
}
...
void ReadRoiExtractorParams(const Value& root,
                            RoiExtractorParams& RoiExtractor) {
