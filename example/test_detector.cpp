...
int main() {
  ...
  // "/home/dl/Project/mmdetection_libtorch/config/ssd.json"; std::string
  // config_file = "/home/dl/Project/mmdetection_libtorch/config/re.json";
  std::string config_file =
      "/home/dl/Project/mmdetection_libtorch/config/faster_rcnn.json";
  Params params;
  ...
  cv::Mat image =
      cv::imread("/home/dl/Project/mmdetection_libtorch/image/000012.jpg");
  ...
  if (res == 0) {
    for (int i = 0; i < detected_boxes.size(); i++) {
      ...
      cv::rectangle(image, detected_boxes[i].box, cv::Scalar(0, 0, 255), 1, 1,
                    0);
    }
